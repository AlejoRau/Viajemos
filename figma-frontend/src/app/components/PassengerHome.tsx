    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="px-6 py-8">
        <div className="max-w-md mx-auto space-y-4">
          {/* Search Trips Card */}
          <button
            onClick={() => navigate("/passenger/search-trips")}
          ...
          >
            ...
            <span className="text-xl font-semibold text-gray-800">Buscar viajes</span>
          </button>

          {/* Create Request Card */}
          <button
            onClick={() => navigate("/passenger/create-request")}
            className="w-full bg-white border-2 border-gray-200 rounded-2xl p-8 shadow-md hover:shadow-lg hover:border-[#1A73E8] transition-all flex flex-col items-center gap-3"
          >
            <div className="w-16 h-16 bg-[#E8F0FE] rounded-full flex items-center justify-center">
              <Megaphone className="w-8 h-8 text-[#1A73E8]" />
            </div>
            <span className="text-xl font-semibold text-gray-800">Publicar que busco viaje</span>
          </button>
        </div>
      </div>
    </div>
