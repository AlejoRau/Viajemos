...
class ProfileRepository {
  ...
  Future<UserProfile> fetchPublicProfile(String userId) async {
    final data = await _client
        .from('profiles')
        .select('full_name, avg_rating, trips_driven, trips_taken, cancelled_trips_count, expelled_passengers_count, kicked_out_count, bio_driver, bio_passenger, instagram, facebook, created_at, birth_date, home_city')
        .eq('id', userId)
        .single();
    ...
    return UserProfile(
      ...
      kickedOutCount: (data['kicked_out_count'] as int?) ?? 0,
